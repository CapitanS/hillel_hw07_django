...
from .models import Author, Book, BookInstance, Genre, Language, LogModel, ObjectsTable, UtilizationRate
...
admin.site.register(ObjectsTable)
admin.site.register(UtilizationRate)
